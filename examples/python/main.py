"""
Example: How to call the similarweb-top-websites-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/similarweb-top-websites-scraper
...
def run_actor():
    """Run the similarweb-top-websites-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/similarweb-top-websites-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.similarweb.com/top-websites/canada/"}],
        }
    )
